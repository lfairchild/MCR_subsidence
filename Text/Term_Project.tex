...
\markboth{L. M. Fairchild}{Midcontinent Rift Subsidence}

\title{Flexural and thermal subsidence in the Midcontinent Rift} % title

\author{Luke M. Fairchild
...
\begin{abstract}
\textbf{Abstract}  We introduce a physiologically-based model for pupil light reflex (PLR)
